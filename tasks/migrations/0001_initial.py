    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('site', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='racks', to='tasks.site')),
            ],
            options={
                'verbose_name': 'Rack',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rack', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='devices', to='tasks.rack')),
